...
//{
//	class Dx11Texture2 : public TextureInterface<Dx11Texture2>, public std::enable_shared_from_this<Dx11Texture2>
//	{
//	public:
//
//		~Dx11Texture2() {};
...
//		Dx11Texture2()
//			: TextureInterface() {};
//		Dx11Texture2(std::shared_ptr<RenderDevice>& renderDevice, void* data, std::string path, unsigned int width, unsigned int height, unsigned int nrChannels, TextureUsage type)
